...
public class PageInfo {
	...
	private int listCount;		// 총 게시글 총수
	private int currentPage;	// 현재 페이지(즉, 요청한 페이지)
	private int startPage;		// 현재 페이지 하단에 보여지게될 페이징바의 시작수
	private int endPage;		// 현재 페이지 하단에 보여지게될 페이징바의 시작수 
	private int maxPage;		// 전체 페이지에서의 가장 마지막 페이지수
	
	private int pageLimit; 		// 한 페이지 하단에 보여질 페이지 최대 갯수
	private int boardLimit; 	// 한 페이지당 게시글 최대 갯수
